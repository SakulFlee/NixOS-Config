...
if wk_ok then
  wk.add({
    ...
    { "<leader>aoI", desc = "Open input (new session)" },
    { "<leader>aoo", desc = "Open output" },
    { "<leader>aos", desc = "Select session" },
    { "<leader>aoq", desc = "Close Opencode" },
    { "<leader>aop", desc = "Configure provider" },
    { "<leader>c",  group = "Code" },
